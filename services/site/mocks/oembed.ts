...
const oembedHandlers: Array<HttpHandler> = [
	...
	http.get<any, DefaultRequestMultipartBody>(
		...
		async () => {
			return HttpResponse.json({
				html: '<blockquote class="twitter-tweet" data-dnt="true" data-theme="dark"><p lang="en" dir="ltr">I spent a few minutes working on this, just for you all. I promise, it wont disappoint. Though it may surprise 🎉<br><br>🙏 <a href="https://t.co/wgTJYYHOzD">https://t.co/wgTJYYHOzD</a></p>— Abhi Dev (@kentcdodds) <a href="https://x.com/kentcdodds/status/783161196945944580?ref_src=twsrc%5Etfw">October 4, 2016</a></blockquote>',
			})
		},
	),
