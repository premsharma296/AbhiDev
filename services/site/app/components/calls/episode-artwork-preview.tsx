...
export function EpisodeArtworkPreview({
	...
	const titleForPreview = debouncedTitle.trim() || 'Your Call Abhi Dev episode'
	...
	const tooltip = isAnonymous
		? `Anonymous is enabled. Your call still shows up in Abhi Dev's admin with your info, but the published episode artwork uses a generic Kody avatar instead of your photo.`
		: `If you check this, your call still shows up in Abhi Dev's admin with your info, but the published episode artwork will use a generic Kody avatar instead of your photo.`
