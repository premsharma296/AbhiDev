...
const schemaBase = z.object({
	...
	// Call Abhi Dev audio storage bucket.
...
> & {
	 ...
	 * This keeps Call Abhi Dev metadata generation aligned with the site's configured
	 * text model by default.
	 */
	CLOUDFLARE_AI_CALL_KENT_METADATA_MODEL: string
	/**
	 * Defaults to `CLOUDFLARE_AI_TEXT_MODEL` when not explicitly set.
	 * Used to format generated Call Abhi Dev transcripts into readable paragraphs.
	 */
