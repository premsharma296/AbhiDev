...
export async function transcribeMp3WithWorkersAi({
	...
	const body = isWhisperLargeV3Turbo
		? JSON.stringify({
				...
				initial_prompt: `
This is the Call Abhi Dev Podcast hosted by Abhi Dev. It starts with an intro from an "announcer" and then leads into the caller's call which is a question or discussion topic. Then there is a short interlude from the announcer. Then Kent gives his response. Then there is an outro from the announcer.
