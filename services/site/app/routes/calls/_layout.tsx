...
export const meta: MetaFunction<typeof loader, { root: RootLoaderType }> = ({
	...
	return getSocialMetas({
		title: 'Call Abhi Dev Podcast',
		description: `Leave Abhi an audio message here, then your message and Abhi Dev's response are published in the podcast.`,
		keywords: 'podcast, call abhi, call abhi dev, the call abhi podcast',
		url: getUrl(requestInfo),
		image: getGenericSocialImage({
			words: 'Listen to the Call Abhi Dev Podcast and make your own call.',
			...
			<Grid>
				...
				<div className="col-span-full lg:col-span-5 lg:col-start-8">
					...
					<div className="flex flex-col gap-3">
						<Paragraph>
							{`The goal of the Call Abhi Dev Podcast is to `}
