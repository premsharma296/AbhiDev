...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
	...
	const title = 'Abhi Dev'
	const description =
		'Come check out how Abhi Dev can help you level up your career as a software engineer.'
	return [
		...
		...getSocialMetas({
			...
			image: getGenericSocialImage({
				...
				words:
					'Building AI-powered products and modern full-stack experiences.',
...
function App({
	...
	return (
		<html
			lang="en"
			className={clsx(theme === 'brand' ? 'brand' : theme, `set-color-team-current-${team.toLowerCase()}`)}
		>
			<head>
				<script
					nonce={nonce}
			...
			<body className={clsx('transition duration-500 bg-white dark:bg-gray-900', theme === 'brand' && 'bg-gradient-to-br from-blue-950 via-red-950 to-black text-white')}>
				<PageLoadingMessage />
				<Promotification
					position="top-center"
					promoName={SEASON_7_PROMOTIFICATION_NAME}
				...
				>
					<div className="space-y-4">
						<p className="font-semibold">
							{`Explore Abhi Dev's latest AI and full-stack projects.`}
						</p>
				...
				<Navbar />
				<AppHotkeys />
				<div className="mx-auto max-w-7xl px-4 dark:bg-transparent bg-transparent"><Outlet /></div>
				<Spacer size="base" />
		...
		<html lang="en" className="dark">
			<head>
				...
				<Links />
                        ...
                        <body className="bg-white transition duration-500 dark:bg-gray-900 brand:bg-gradient-to-br brand:from-blue-950 brand:via-red-950 brand:to-black">
				{children}
				<Scripts nonce={nonce} />
			</body>
		</html>
