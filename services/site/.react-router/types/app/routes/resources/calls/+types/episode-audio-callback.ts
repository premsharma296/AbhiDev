...
type Module = typeof import("../episode-audio-callback.js")

type Info = GetInfo<{
  file: "routes/resources/calls/episode-audio-callback.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../episode-audio-callback.js");
}];
