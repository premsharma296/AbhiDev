...
type Module = typeof import("../verify-authentication.js")

type Info = GetInfo<{
  file: "routes/resources/webauthn/verify-authentication.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../verify-authentication.js");
}];
