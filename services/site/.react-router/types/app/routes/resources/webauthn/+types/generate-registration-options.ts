...
type Module = typeof import("../generate-registration-options.js")

type Info = GetInfo<{
  file: "routes/resources/webauthn/generate-registration-options.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../generate-registration-options.js");
}];
