...
date: 2026-03-09
description:
  'How I moved Call Abhi Dev podcast episode processing off my primary Fly.io app
...
For 226 episodes of my [Call Abhi Dev podcast](/calls), I recorded audio, combined
...
Call Abhi Dev episode and hit publish. My app runs FFmpeg during the publish flow:
...
started building the Call Abhi Dev feature, I could have designed a proper job
...
When a Call Abhi Dev episode is submitted, the app enqueues a job to a Cloudflare
